            ...
            <div class="container h-100">
                ...
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h3 class="text-uppercase text-white font-weight-bold">Belajar ilmu agama dan Teknologi Informasi</h3>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Semoga Allah <i>Subhana Wa Ta'ala</i> memberikan kita semua ilmu yang bermanfaat untuk akhirat dan dunia</p>
